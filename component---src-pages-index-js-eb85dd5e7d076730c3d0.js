...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _raf = __webpack_require__(334);
	
	var _raf2 = _interopRequireDefault(_raf);
	
	var _shouldUpdate2 = __webpack_require__(823);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var spacing_style = { marginBottom: (0, _typography.rhythm)(1.0) };
	
	exports.default = function (_ref) {
	  var _ref$style = _ref.style,
	      style = _ref$style === undefined ? {} : _ref$style,
	      authors_count = _ref.authors_count;
	  return _react2.default.createElement(
	    'div',
	    { style: _extends({}, base_bio_style, style) },
	    _react2.default.createElement(
	      'span',
	      { style: spacing_style },
	      'yerevancoder.com is a place for coders in Armenia to share their thoughts, experiences in programming and tech. ',
	      authors_count,
	      ' coders have already contributed and we are always looking for more contributors, add a post',
	      ' ',
	      _react2.default.createElement(
	        'a',
	        { href: 'https://github.com/yerevancoder/yerevancoder.github.io' },
	        'here'
	      )
	    ),
	    _react2.default.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactHeadroom = __webpack_require__(822);
	
	var _reactHeadroom2 = _interopRequireDefault(_reactHeadroom);
	
	var _Bio = __webpack_require__(456);
	...
	var with_margin_bottom = { marginBottom: (0, _typography.rhythm)(1 / 4) };
	...
	var BlogIndex = function (_React$Component) {
	  ...
	  function BlogIndex() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { showing_header: false, authenticated_user: null }, _this.unpinned = function () {
	      return _this.setState(function () {
	        return { showing_header: true };
	      });
	    }, _this.unfixed = function () {
	      return _this.setState(function () {
	        return { showing_header: false };
	      });
	  ...
	  BlogIndex.prototype.render = function render() {
	    ...
	    var posts = (0, _get2.default)(this, 'props.data.allMarkdownRemark.edges');
	    var header_style = {};
	    if (this.state.showing_header === true) header_style = this.props.header_style;
	    var all_authors = new Set(posts.map(function (_ref) {
	      var node = _ref.node;
	      return node.frontmatter.author;
	    }));
	    var authors_count = all_authors.size;
	    return _react2.default.createElement(
	      'div',
	      null,
	      ...
	      _react2.default.createElement(
	        ...
	        { onPin: this.pinned, onUnpin: this.unpinned, onUnfix: this.unfixed },
	        _react2.default.createElement(_Bio2.default, { style: header_style, authors_count: authors_count })
	      ),
	      posts.map(function (_ref2) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: node.excerpt } })
	        );
	      })
	    );
	  };
...
//# sourceMappingURL=component---src-pages-index-js-eb85dd5e7d076730c3d0.js.map